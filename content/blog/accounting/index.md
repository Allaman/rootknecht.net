...
resources:
  - name: head
    src: head.png
    title: Generated by DALL-E
  - name: add
    src: add.png
    title: Adding transactions
  - name: lebensmittel
    src: lebensmittel.png
    title: Expenses for groceries per month
  - name: sprit
    src: sprit.png
    title: Expenses for gasoline per month
  - name: dashboard
    src: dashboard.png
    title: Both charts in the dashboard view
  - name: unraid
    src: unraid.png
    title: Mounting my ledger folder in the Metabase container
  - name: database
    src: database.png
    title: Adding a database to Metabase
---
...
{{< img name=head lazy=false size=small >}}
...
{{< img name=lebensmittel lazy=true >}}

{{< img name=sprit lazy=true >}}

{{< img name=dashboard lazy=true >}}
